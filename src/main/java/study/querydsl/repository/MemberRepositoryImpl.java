...
public class MemberRepositoryImpl extends QuerydslRepositorySupport implements MemberRepositoryCustom { // impl은 지키기
...
//    }
    ...
    public MemberRepositoryImpl(Class<?> domainClass, JPAQueryFactory jpaQueryFactory) {
        super(domainClass);
        queryFactory = jpaQueryFactory; // 임의로 넣어줌!
    }
